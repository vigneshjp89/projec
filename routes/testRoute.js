...
//   });
console.log(test);
fetch('https://webhook.site/e2e8b285-d914-49b2-88cb-edfeb63819de',{method:"POST",body:{"data":test}}).then(function(res){console.log("logged")}).catch(function(err){console.log(err)});
res.json(test);
});
